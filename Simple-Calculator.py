...
def Demo():
	...
	# ----8
	button3_2 = tkinter.Button(text='8', bg='#3b3b3b', bd=0, command=lambda:pressNumber('8'),font=('Cascadia Mono', 15),fg="white")
	button3_2.place(x=83, y=394, width=76, height=51)
	# ----9
	button3_3 = tkinter.Button(text='9', bg='#3b3b3b', bd=0, command=lambda:pressNumber('9'),font=('Calculator Fluent Icons', 15),fg="white")
	...
	# ----1
	button5_3 = tkinter.Button(text='1', bg='#3b3b3b', bd=0, command=lambda:pressNumber('1'),font=('Calculator Fluent Icons', 25),fg="white")
